...
function Header() {
    ...
    return (
        <div className="shadow-sm border-b dark:border-gray-800 bg-white dark:bg-gray-900 sticky top-0 z-50">
            <div className="flex justify-between bg-white dark:bg-gray-900 max-w-6xl mx-5 lg:mx-auto">
                {/* Left */}
                {/* Mobile View */}
